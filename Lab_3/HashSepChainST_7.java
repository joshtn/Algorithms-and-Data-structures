 ...
 * @Author Josh
 * @Made 29/9/2019
 * @ProblemSolved Hashing with seperate chaining comparing with linear probing.
 * @HowToUse run main, change value of how many strings you want to read.
 * @BasedOn Algoritms 4th edition and lectures.
 */
public class HashSepChainST_7<Key, Value> {
    ...
    private void resize(int chains) {
        HashSepChainST_7<Key, Value> temp = new HashSepChainST_7<>(chains);
        for (int i = 0; i < m; i++) {
